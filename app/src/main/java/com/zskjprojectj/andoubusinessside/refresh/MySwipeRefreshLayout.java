package com.zskjprojectj.andoubusinessside.refresh;
...
public class MySwipeRefreshLayout extends ViewGroup {
    ...
    public void setColorSchemeResources(int holo_blue_bright, int holo_green_light, int holo_orange_light, int holo_red_light) {
    }
